...
class ArabicPronounceDialog(context: Context, currentPosition: Int) : BaseDialog(context, R.layout.item_dialog_video) {
    ...
    var path = "android.resource://" + context.packageName + "/" + data[currentPosition].letterPronounVideo
