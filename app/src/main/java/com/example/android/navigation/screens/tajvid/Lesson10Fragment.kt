...
import com.example.android.navigation.databinding.Lesson10FragmentBinding
...
class Lesson10Fragment: Fragment() {
    ...
    lateinit var binding: Lesson10FragmentBinding
    override fun onCreateView(
            inflater: LayoutInflater, container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson10_fragment, container, false)
        ...
        binding.text.text = context!!.resources.getString(R.string.yoi_alififya)
        binding.text.typeface = font
        mPlayer_1 = MediaPlayer.create(context, R.raw.yoi_alifiya)
