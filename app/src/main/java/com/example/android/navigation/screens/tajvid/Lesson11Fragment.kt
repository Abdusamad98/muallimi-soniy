...
class Lesson11Fragment: Fragment() {
    ...
    lateinit var binding: Lesson11FragmentBinding
    override fun onCreateView(
            inflater: LayoutInflater, container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson11_fragment, container, false)


        val font = Typeface.createFromAsset(context!!.assets, "quran.TTF")


        binding.text.text = context!!.resources.getString(R.string.vovi_alifiya)
        binding.text.typeface = font
        mPlayer_1 = MediaPlayer.create(context, R.raw.vovi_alifiya)
