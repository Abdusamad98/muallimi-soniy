...
class Lesson12Fragment : Fragment() {
    ...
    lateinit var binding: Lesson12FragmentBinding
    override fun onCreateView(
            inflater: LayoutInflater, container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson12_fragment, container, false)
        ...
        binding.text3.text = context!!.resources.getString(R.string.text3)
        binding.text3.typeface = font



        binding.text4.text = context!!.resources.getString(R.string.text4)
        binding.text4.typeface = font



        binding.text5.text = context!!.resources.getString(R.string.text5)
        binding.text5.typeface = font


        binding.text6.text = context!!.resources.getString(R.string.text6)
        binding.text6.typeface = font



        mPlayer_1 = MediaPlayer.create(context, R.raw.yozilsada_oqilmaydi)
