...
class Lesson14Fragment: Fragment() {
    ...
    lateinit var binding: Lesson14FragmentBinding
    override fun onCreateView(
            inflater: LayoutInflater, container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson14_fragment, container, false)




        val spannable = SpannableString("Vaqf - to'xtash demakdir. Qur'oni Karimda vaqf alomatlari" +
                "qo'yilan o'rinlarda biroz biroz to'xtab,nafas olinadi, so'ng to'xtash alomati oldidagi" +
                "so'zlarni o'qib tugatganda,o'rniga qarab yo sukun, yoki alif,yohud sukunli ha ('ة') bilan vaqf qilinadi. Misollar:\n")
        spannable.setSpan(
                RelativeSizeSpan(2f),
                spannable.indexOf("ة"), // start
                spannable.indexOf("ة") + 1, // end
        ...
        binding.text.text = context!!.resources.getString(R.string.vaqf)
        binding.text.typeface = font




        mPlayer_1 = MediaPlayer.create(context, R.raw.vaqf)
