...
class Lesson15Fragment: Fragment() {
    ...
    lateinit var binding: Lesson15FragmentBinding
    override fun onCreateView(
            inflater: LayoutInflater, container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson15_fragment, container, false)


        val spannable = SpannableString("Mad - cho'zib o'qish demakdir. Quyidagi misollarda alif " +
                ", vov, hamda yo harflari ustiga mad belgisi (ـٓ ) qo'yiladi. Misollar:\n")
        spannable.setSpan(
                RelativeSizeSpan(2f),
                spannable.indexOf("ـٓ"), // start
                spannable.indexOf("ـٓ") + 2, // end
        ...
        binding.text.text = context!!.resources.getString(R.string.mad)
        binding.text.typeface = font




        mPlayer_1 = MediaPlayer.create(context, R.raw.mad)
