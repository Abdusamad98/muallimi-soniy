...
import com.example.android.navigation.databinding.Lesson18FragmentBinding
...
class Lesson18Fragment : Fragment() {
    ...
    lateinit var binding: Lesson18FragmentBinding
    override fun onCreateView(
            inflater: LayoutInflater, container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson18_fragment, container, false)


        val font = Typeface.createFromAsset(context!!.assets, "majallab.ttf")


        binding.text.text = context!!.resources.getString(R.string.muqatta)
       // binding.text.typeface = font




        mPlayer_1 = MediaPlayer.create(context, R.raw.ayrim_suralar_boshi)
