...
class Lesson2Fragment: Fragment() {
    ...
    lateinit var binding: Lesson2FragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson2_fragment, container, false)

        val font = Typeface.createFromAsset(context!!.assets, "majallab.ttf")
          binding.text.text = context!!.resources.getString(R.string.tashdid)
          binding.text.typeface = font
        mPlayer_1 = MediaPlayer.create(context, R.raw.tashdidli_harflar)
