...
import com.example.android.navigation.databinding.Lesson2FragmentBinding
...
class Lesson3Fragment : Fragment() {
    ...
    lateinit var binding: Lesson3FragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson3_fragment, container, false)


        val font = Typeface.createFromAsset(context!!.assets, "majallab.ttf")

        binding.text.text = context!!.resources.getString(R.string.tanvin)
        binding.text.typeface = font
        mPlayer_1 = MediaPlayer.create(context, R.raw.tanvinli_harflar)
