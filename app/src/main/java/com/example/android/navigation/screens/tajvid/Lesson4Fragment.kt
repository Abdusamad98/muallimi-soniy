...
import com.example.android.navigation.databinding.Lesson3FragmentBinding
import com.example.android.navigation.databinding.Lesson4FragmentBinding
...
class Lesson4Fragment: Fragment() {
    ...
    lateinit var binding: Lesson4FragmentBinding
    override fun onCreateView(
            inflater: LayoutInflater, container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson4_fragment, container, false)




        val font = Typeface.createFromAsset(context!!.assets, "majallab.ttf")
        binding.text.text = context!!.resources.getString(R.string.tanvinli_tashdid)
        val font1 = Typeface.createFromAsset(context!!.assets, "MyriadPro-Regular.otf")
        binding.textSign.text = "ــًّ   ــٍّ   ــٌّ"
        binding.text.typeface = font
        binding.textSign.typeface =font1
        mPlayer_1 = MediaPlayer.create(context, R.raw.tanvinli_tashdid)
