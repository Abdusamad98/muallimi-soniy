...
import com.example.android.navigation.databinding.Lesson7FragmentBinding
...
class Lesson7Fragment: Fragment() {
    ...
    lateinit var binding: Lesson7FragmentBinding
    override fun onCreateView(
            inflater: LayoutInflater, container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(
                inflater, R.layout.lesson7_fragment, container, false)
        ...
        binding.text.text = context!!.resources.getString(R.string.ortirilgan_alif)
        binding.text.typeface = font
        mPlayer_1 = MediaPlayer.create(context, R.raw.ortirilgan_alif)
